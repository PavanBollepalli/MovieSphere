...
const MovieBio = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative font-sans max-w-6xl mx-auto p-6 text-white space-y-6">
        <Link
          to="/"
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/3">
            <div className="rounded-lg overflow-hidden shadow-lg transition-shadow duration-300 hover:shadow-violet-500/50">
              <img
                src={
            ...
            {/* Rating Card */}
            <div className="mt-6 bg-gray-800 rounded-lg p-4 shadow-md transition-transform duration-300 hover:scale-105">
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                {movieDetails.genres &&
                  movieDetails.genres.map((genre) => (
                    <div
                      key={genre.id}
                      className="px-3 py-1 bg-violet-800/60 rounded-full text-sm transition transform duration-200 hover:scale-105"
                    >
                      {genre.name}
                    </div>
                  ))}
